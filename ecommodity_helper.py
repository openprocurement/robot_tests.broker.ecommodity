...
def convert_ecommodity_string(string):
    return {
            ...
            u'LOT_Публікація інформаційного повідомлення':                  'composing',
            u'LOT_Перевірка доступності об’єкту':                           'verification',
            ...
            u'SELLOUT_Очікується підписання договору':       'active.awarded',
